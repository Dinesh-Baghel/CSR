...
namespace Application.Services
{
    public class MenuService
    {
        ...
        public async Task<CopLoginRes?> GetUserLoginData()
        {
            ...
            {
                // Start Commented By chandra on 16 Apr 2024
                //var LoginRes = context.User.FindFirst(CustomClaimTypes.LoginRes)?.Value;
                //var menusClaim = context.User.FindFirst("Menus")?.Value;
                //if (LoginRes != null)
                //{
                //    _CopLoginRes = JsonSerializer.Deserialize<CopLoginRes>(LoginRes);
                //}
                // End Commented By chandra on 16 Apr 2024
